...
create_checksums "./storegenerator/static/themes/assets" "checksums_storegenerator_assets_uncompressed.txt"

# Compress images
echo "Compressing images..."
tar czvf images_main.tar.gz -C . static/images
tar czvf images_storegenerator.tar.gz -C . storegenerator/static/images
tar czvf images_storegenerator_assets.tar.gz -C . storegenerator/static/themes/assets
...
sha256sum images_storegenerator_assets.tar.gz > checksums_storegenerator_assets_compressed.txt
# SCP the compressed files and checksums to the server
echo "Copying files to server..."
scp images_main.tar.gz images_storegenerator.tar.gz images_storegenerator_assets.tar.gz checksums_*.txt alan@191.101.14.169:/var/www/DungeonMind/
